...
class Worker:
    ...
    """
    def _get_gpu_usage(self, id, uuid):
...
#               print(perf_metrics)
                ...
                if num_procs == 0:
                    ...
                    sm_threshold = self._convert_to_mib(config["small_job_threshold"])
